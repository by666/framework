...
-(void)initView{
    ...
    [self addSubviewInBtn:_propertyBtn title:MSG_MESSAGE_PROPERTY_BTN image:nil superscript:2];
    ...
    [self addSubviewInBtn:_systemBtn title:MSG_MESSAGE_SYSTEM_BTN image:nil superscript:199];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell setSelectedBackgroundView:[self selectView]];
